...
function pp_author_chat_chat_on_top()
{
	...
	?>
				...
				$_dialogTitleBar.mouseup( function()
				{
					...
					if ( $_dialogWindow.hasClass( 'ui-dialog-dragging' ) || $_dialogWindow.hasClass( 'ac-sidebar' ) ) return;
				...
				jQuery( window ).load( function()
				{
					...
					if ( $_dialogWindow.hasClass( 'ac-sidebar' ) ) return;
					fixPosition();
				});
