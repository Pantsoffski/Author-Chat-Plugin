...
if (isset($_POST['function'])) {
    ...
    if (isset($_POST['user_time_zone'])) {
        $user_time_zone = strip_tags(filter_var($_POST['user_time_zone'], FILTER_SANITIZE_STRING));
    } else {
        $user_time_zone = '0';
    }
...
//                });
		...
		");
            ...
            $user_id = strip_tags(filter_var($_POST['user_id'], FILTER_SANITIZE_NUMBER_INT));
            $room_id = strip_tags(filter_var($_POST['room_id'], FILTER_SANITIZE_NUMBER_INT));
        ...
        case( 'searchUser' ):
            if (isset($_POST['search_user'])) {
                $user_name = strip_tags(filter_var($_POST['search_user'], FILTER_SANITIZE_STRING, array('flags' => FILTER_FLAG_STRIP_LOW | FILTER_FLAG_ENCODE_HIGH)));
...
//    $topic = preg_replace('~^(?:https?://)?(?:www[.])?~i', '', '$_SERVER['SERVER_NAME']');
//    $topic = explode('.', $topic);
//    $topic = $topic[0];
